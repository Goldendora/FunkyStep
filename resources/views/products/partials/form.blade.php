...
<div class="row">
    ...
    <div class="mb-3">
        ...
        @if(isset($product) && !empty($product->image))
            <div class="mt-2">
                <img src="{{ asset('storage/' . $product->image) }}" width="120" height="120" class="rounded shadow-sm"
    ...
    <div class="form-check form-switch mb-4">
        <input class="form-check-input" type="checkbox" name="is_active" id="is_active" {{ boolval(old('is_active', $product->is_active ?? false)) ? 'checked' : '' }}>
